...
const Navbar = () => {
    return (
        <div className='fixed w-full py-4 bg-white dark:text-white dark:bg-slate-900 align-middle cursor-default'>
            <nav className="container mx-auto">
                <div className="flex justify-between md:px-16 px-8">
                    ...
                    <div className="md:flex md:space-x-8 text-md">
                            ...
                            <div className="hidden md:block hover:font-semibold my-auto align-middle">Contact</div>
