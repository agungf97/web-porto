    ...
    return (
        <div className="container mx-auto align-middle">
            <div className="md:my-32 md:px-80 px-16 text-center dark:text-white">
              ...
              <h1 className="md:py-4 py-2 md:text-4xl text-xl font-black hover:-translate-y-2 duration-500"> Mohamad <span className="text-orange-600 md:text-6xl">Agung</span> Faisal</h1>
